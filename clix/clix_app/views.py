...
from .models import ClixShortner
...
def home(request):
    ...
    if request.method =="POST":
        ...
        obj = ClixShortner.objects.create(original_url=original_url)
...
def redirect_link(request, shortened_link):
    link = get_object_or_404(ClixShortner, shortened_link= shortened_link)
